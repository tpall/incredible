...
See töö on korrektne lõpetada imporditud ja puhastatud tabeli salvestamisega `output` kataloogi. `output` kataloogi võib panna kõik andmetöötluse ja analüüsi artefaktid.
