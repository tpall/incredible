...
tidy_gpx.R ja extract_date.R skriptid on saadaval minu GitHub repos [tpall/norra2017]( https://github.com/tpall/norra2017/tree/master/lib).
...
ggplot(tracks_gat, aes(str_wrap(str_c(date, trip, sep = ", "), 30), value, fill = key)) + 
